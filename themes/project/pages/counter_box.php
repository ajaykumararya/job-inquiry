<div class="container-xxl py-5">
    <div class="container cms-counter wow fadeInUp" data-wow-delay="0.1s">
        <div class="row">
            <?php
            $our_counters = [
            ...
            <div class="col-md-3 col-sm-6">
                    <div class="counter ' . $color[$i++] . '">
                        ...
                        <span class="counter-value" sign="' . $plus_sign . '">' . $counter . '</span>
                        <h3>' . $title . '</h3>
                    </div>
                </div>
...
<style>
    ...
    .cms-counter .counter .counter-value::after {
        content: attr(sign);
    }
