document.addEventListener('DOMContentLoaded', function (e) {
    const delete_url = 'job/delete-sub-category';
    const form = document.getElementById('add_course_category');
    const list_url = 'job/list-sub-category';
    const save_url = 'job/add-sub-category';
    ...
    if (table.length) {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<div class="btn-group">
                                    ...
                                    ${deleteBtnRender(0, row.job_category_id)}
                                </div>
                                `;
                    }
                }
        ...
        dt.on('draw', function (e) {
            EditForm(table, 'job/edit-sub-category', 'Update Sub Category');
